module "resource_group" {
  source = "git::https://bitbucket.org/jyothik25/azure-aks-modules.git//modules/resource_group?ref=main"
...
module "acr" {
  source              = "git::https://bitbucket.org/jyothik25/azure-aks-modules.git//modules/acr?ref=main"
  name                = var.acr_name
...
module "network" {
 source = "git::https://bitbucket.org/jyothik25/azure-aks-modules.git//modules/network?ref=main"
...
module "aks" {
  ...
  source = "git::https://bitbucket.org/jyothik25/azure-aks-modules.git//modules/aks?ref=main"
  resource_group_name = module.resource_group.resource_group_name
  location            = var.location
